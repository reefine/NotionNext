...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'i悟空', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '爱悟空，i电影', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://m.iwukong.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '最新,电影,下载电,视剧', // 网站关键词 英文逗号隔开
